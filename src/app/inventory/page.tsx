    ...
    try {
      ...
      if (data.success) {
        ...
        setAlert({
          isOpen: true,
          title: 'Error',
          message: data.error || 'Gagal menghapus stok.',
          type: 'error'
        });
      }
    } catch (error) {
          ...
          <div className="bg-white rounded-lg p-6 max-w-md w-full mx-4">
            ...
            <div className="mb-6">
              <p className="text-sm text-gray-500">
                Apakah Anda yakin ingin menghapus stok <strong>"{deleteConfirm.item.product_name}"</strong> di lokasi <strong>"{deleteConfirm.item.store_location}"</strong>?
              </p>
